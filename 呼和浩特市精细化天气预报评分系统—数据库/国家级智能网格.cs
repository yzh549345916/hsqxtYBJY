...
namespace 呼和浩特市精细化天气预报评分系统_数据库
{
    partial class 智能网格类1
    {
        ...
        public string GJYBRK(string strTime, Int16 sc, ref int count)
        {
            count = 0;
            string error = "";
        ...
        /// <returns></returns>
        private bool PDGJSJ(string strTime, Int16 sc, string sx, string ysName,int minSX,int maxSX)
        {
            try
            {
                using (SqlConnection mycon = new SqlConnection(con))
        ...
        /// <returns></returns>
        public string CIMISSGJZNbyTimeJWD(string strTime, Int16 sc, string sx, string cc, string fcstEle, double swd, double ewd, double sjd, double ejd, ref string error)
        {
            /* 1. 定义client对象 */
        ...
        public void CLGJZN(string strTime, Int16 sc, string sx, string fcstEle, string strData, List<ZDList> zDLists, int minSX, int maxSX,ref string error)
        {
