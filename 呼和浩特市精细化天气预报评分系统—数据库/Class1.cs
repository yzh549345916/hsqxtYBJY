    ...
    class Class1
    {
        ...
        public string TJCZRKnew(string QXID, DateTime dt, string SC, string GW) //指定时间的24小时预报与实况差值入库 dt为预报时间 返回错误信息
        {
            ...
            using (SqlConnection mycon = new SqlConnection(con))
            {
                ...
                sql = $"update TJ set SJ_SKTmax24='{SJSKTmax24}',SJ_SKTmin24='{SJSKTmin24}',SJ_Rain24='{SJSKRain24}',SFzhundian='{SFZD24}',SJ_Rain0012='{SJSKRain2412}',SJ_Rain1224='{SJSKRain2424}' where StationID='{QXID}' and Date='{dt:yyyy-MM-dd}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set ZY_SKTmax24='{ZYSKTmax24}',ZY_SKTmin24='{ZYSKTmin24}',ZY_Rain24='{ZYSKRain}',ZY_Rain0012='{ZYSKRain12}',ZY_Rain1224='{ZYSKRain24}' where StationID='{QXID}' and Date='{dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set SJ_SKTmax48='{SJSKTmax48}',SJ_SKTmin48='{SJSKTmin48}',SJ_Rain48='{SJSKRain48}',SJ_Rain2436='{SJSKRain2412}',SJ_Rain3648='{SJSKRain2424}' where StationID='{QXID}' and Date='{dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set ZY_SKTmax48='{ZYSKTmax48}',ZY_SKTmin48='{ZYSKTmin48}',ZY_Rain48='{ZYSKRain}',ZY_Rain2436='{ZYSKRain12}',ZY_Rain3648='{ZYSKRain24}' where StationID='{QXID}' and Date='{dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set SJ_SKTmax72='{SJSKTmax72}',SJ_SKTmin72='{SJSKTmin72}',SJ_Rain72='{SJSKRain72}',SJ_Rain4860='{SJSKRain2412}',SJ_Rain6072='{SJSKRain2424}' where StationID='{QXID}' and Date='{dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set ZY_SKTmax72='{ZYSKTmax72}',ZY_SKTmin72='{ZYSKTmin72}',ZY_Rain72='{ZYSKRain}',ZY_Rain4860='{ZYSKRain12}',ZY_Rain6072='{ZYSKRain24}' where StationID='{QXID}' and Date='{dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set SJ_SKTmax96='{SJSKTmax96}',SJ_SKTmin96='{SJSKTmin96}',SJ_Rain96='{SJSKRain96}',SJ_Rain7284='{SJSKRain2412}',SJ_Rain8496='{SJSKRain2424}' where StationID='{QXID}' and Date='{dt:yyyy-MM-dd}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $@"update TJ set ZY_SKTmax96='{ZYSKTmax96}',ZY_SKTmin96='{ZYSKTmin96}',ZY_Rain96='{ZYSKRain}',ZY_Rain7284='{ZYSKRain12}',ZY_Rain8496='{ZYSKRain24}' where StationID='{QXID}' and Date='{dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set SJ_SKTmax120='{SJSKTmax120}',SJ_SKTmin120='{SJSKTmin120}',SJ_Rain120='{SJSKRain120}',SJ_Rain96108='{SJSKRain2412}',SJ_Rain108120='{SJSKRain2424}' where StationID='{QXID}' and Date='{dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
                ...
                sql = $"update TJ set ZY_SKTmax120='{ ZYSKTmax120}',ZY_SKTmin120='{ ZYSKTmin120}',ZY_Rain120='{ ZYSKRain}',ZY_Rain96108='{ ZYSKRain12}',ZY_Rain108120='{ ZYSKRain24}' where StationID='{ QXID}' and Date='{ dt.ToString("yyyy-MM-dd")}'and SC='{SC}'and GW='{GW}'";
                try
                {
                    SqlCommand sqlman = new SqlCommand(sql, mycon);
                    //执行数据库语句并返回一个int值（受影响的行数）  
